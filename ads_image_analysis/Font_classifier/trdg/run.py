...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="?",
        help="Define the range of height of generated image, height will be sampled uniformly between the inputed range, input in ?,? format.",
        default="None",
    )
    ...
    #     type=str,
    #     nargs="?",
    #     help="Define the range of width of generated image, width will be sampled uniformly between the inputed range, input in ?,? format.",
    #     default="None",
    # )
    ...
    for _ in tqdm(
        p.imap_unordered(
            ...
            zip(
                ...
                [args.random_format] * string_count,
